...
const content = {
  fr: {
    ...
    plans: [
      ...
      },
      {
        ...
        features: ['Invités illimités', 'Photo de couple sur l\'invitation', 'Notifications e-mail par RSVP', 'Co-organisateur·trice (2ᵉ contact)', 'Support prioritaire'],
  ...
  he: {
    ...
    plans: [
      ...
      },
      {
        ...
        features: ['מוזמנים ללא הגבלה', 'תמונת זוג בהזמנה', 'התראות אימייל על RSVP חדש', 'שותף/ה נוסף/ת לעדכוני RSVP', 'תמיכה מועדפת'],
  ...
  en: {
    ...
    features: [
      ...
      { icon: '🌐', title: 'Multilingual',           desc: 'French, Hebrew and English — overy guest reads in their language.' },
    ...
    plans: [
      ...
      },
      {
        ...
        features: ['Unlimited guests', 'Couple photo on invitation', 'Email notifications per RSVP', '2nd contact for RSVP updates', 'Priority support'],
