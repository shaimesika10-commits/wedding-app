...
export default function AdminSettingsPage() {
  ...
  const sections = [
    { title: 'Freemium Limits', desc: 'Control what users can do on the free plan.', keys: ['max_free_guests'] },
    { title: 'Features', desc: 'Enable or disable platform features globally.', keys: ['gallery_enabled', 'ai_chat_enabled'] },
    { title: 'Site', desc: 'General site configuration.', keys: ['maintenance_mode', 'support_email'] },
  ]
                    ...
                    {meta.type === 'toggle' ? (
                      <div className="flex items-center gap-2 flex-shrink-0">
                        ...
                        <button
                          ...
                          disabled={!!isSaving}
                          className={'relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none disabled:opacity-50 ' + (value === 'true' ? 'bg-[#c9a84c]' : 'bg-stone-200')}
                        >
